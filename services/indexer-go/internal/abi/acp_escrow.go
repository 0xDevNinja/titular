...
// ESCROWWITNESSTYPE is a free data retrieval call binding the contract method 0x0c68adf6.
//
// Solidity: function ESCROW_WITNESS_TYPE() view returns(string)
func (_Escrow *EscrowCaller) ESCROWWITNESSTYPE(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Escrow.contract.Call(opts, &out, "ESCROW_WITNESS_TYPE")
...
//
// Solidity: function ESCROW_WITNESS_TYPE() view returns(string)
func (_Escrow *EscrowSession) ESCROWWITNESSTYPE() (string, error) {
	return _Escrow.Contract.ESCROWWITNESSTYPE(&_Escrow.CallOpts)
}

// ESCROWWITNESSTYPE is a free data retrieval call binding the contract method 0x0c68adf6.
//
// Solidity: function ESCROW_WITNESS_TYPE() view returns(string)
func (_Escrow *EscrowCallerSession) ESCROWWITNESSTYPE() (string, error) {
	return _Escrow.Contract.ESCROWWITNESSTYPE(&_Escrow.CallOpts)
}

// ESCROWWITNESSTYPEHASH is a free data retrieval call binding the contract method 0x5b3f2bdc.
//
// Solidity: function ESCROW_WITNESS_TYPEHASH() view returns(bytes32)
func (_Escrow *EscrowCaller) ESCROWWITNESSTYPEHASH(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Escrow.contract.Call(opts, &out, "ESCROW_WITNESS_TYPEHASH")
...
//
// Solidity: function ESCROW_WITNESS_TYPEHASH() view returns(bytes32)
func (_Escrow *EscrowSession) ESCROWWITNESSTYPEHASH() ([32]byte, error) {
	return _Escrow.Contract.ESCROWWITNESSTYPEHASH(&_Escrow.CallOpts)
}

// ESCROWWITNESSTYPEHASH is a free data retrieval call binding the contract method 0x5b3f2bdc.
//
// Solidity: function ESCROW_WITNESS_TYPEHASH() view returns(bytes32)
func (_Escrow *EscrowCallerSession) ESCROWWITNESSTYPEHASH() ([32]byte, error) {
	return _Escrow.Contract.ESCROWWITNESSTYPEHASH(&_Escrow.CallOpts)
}
